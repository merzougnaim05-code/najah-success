      ...
      <div className="split-panel">
        ...
        <div>
          <div className="card pad card-hover">
            <b style={{ color: "var(--maroon-2)", fontSize: 15.5 }}>معلومات التواصل</b>
          ...
          <div className="card pad" style={{ marginTop: 14, background: "linear-gradient(160deg, var(--maroon-3), var(--maroon-2))", color: "#fff" }}>
            <b style={{ fontSize: 15 }}>نصيحة سريعة</b>
            <p style={{ fontSize: 13, color: "#f0d9b8", marginTop: 6, lineHeight: 1.9 }}>
